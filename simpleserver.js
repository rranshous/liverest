...
(function() {
  var cells, file, get_cell_data, get_cell_value, io, last_cell_id, next_cell_id, set_cell_data, set_cell_value;

  file = new require('node-static').Server('./public');

  require('http').createServer(req, resp(function() {
  ...
  io.sockets.on('connection', function(socket) {
    ...
    return socket.on('set_cell_data', function(data) {
      var _this = this;
